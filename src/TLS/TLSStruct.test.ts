...
//const testSpec = {
//	enum: TypeSpecs.define.Enum("uint16", "doesn't matter"),
//	number: "uint8",
//	vectorF: TypeSpecs.define.Vector(TypeSpecs.define.Number("uint32"), 2, 2),
//	vectorV: TypeSpecs.define.Vector(TypeSpecs.define.Number("uint24"), 0, 4),
//};

//const nestedSpec = {
//	nested: new TypeSpecs.Struct({ property: "uint8" })
//};
...
//		const V = TypeSpecs.define.Vector(TypeSpecs.define.Number("uint8", 2);
